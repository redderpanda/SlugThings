...
public class Level_1_Game_Manager : MonoBehaviour {
    ...
    public GameObject exit_trigger_light;
    ...
    void Update()
    {
        ...
        if (CheckRatio(player1.GetComponent<SpriteRenderer>().color) == exit_color)
        {
            ...
            exit_trigger.GetComponent<BoxCollider2D>().enabled = true;
            exit_trigger_light.GetComponent<SpriteRenderer>().color = temp;
        }
        else
        {
            Color temp = exit.GetComponent<SpriteRenderer>().color;
            ...
            exit_trigger.GetComponent<BoxCollider2D>().enabled = false;
            exit_trigger_light.GetComponent<SpriteRenderer>().color = temp;
        }
    }
